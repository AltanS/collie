...
- **Releases ship an Intel Mac binary.** A `macos-x64` payload joins the release, built on GitHub's last Intel runner image, so an Intel Mac installs and updates from a binary instead of building from source. Contributed by [@ryands17](https://github.com/ryands17) ([#239](https://github.com/AltanS/collie/pull/239))
