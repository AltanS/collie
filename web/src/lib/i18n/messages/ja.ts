...
export const ja: Dictionary = {
  ...
  "pack.title": "クルー",
  "pack.nav.back": "戻る",
  "pack.entry.title": "クルー 概要",
  "pack.entry.description": "クルー内の全マシンの稼働状態。",
  "pack.footer.label": "クルー · {machines} · {reachable}",
  "pack.footer.aria": "クルー概要を開く",
  ...
  "pack.formation.aria": "クルー構成: {machines}",
  "pack.node.aria": "{name}、{role}、{health}",
  "pack.node.ariaPlain": "{name}、{health}",
  "pack.solo.title": "このCollieはクルーを主導していません",
  "pack.solo.description": "クルーの作成や変更はCLIから行います。",
  "pack.error.title": "クルーの状態を取得できませんでした",
  ...
  // --- M16/01: the updates page, its pack lines and the Settings row ---
  "settings.updateCard.actionPack": "クルーを {version} に更新",
  "settings.updateCard.retryPack": "クルーの更新を再試行",
  "settings.updateCard.retryNow": "再試行",
  "settings.updateCard.packConfirmTitle": "クルーを {version} に更新しますか?",
  "settings.updateCard.packConfirmBody": "まずこのマシンを更新します。その後、各メンバーが同じリリースに合わせ、自身のヘルスチェックを行い、失敗時は自動でロールバックします。",
  "settings.updateCard.packConfirmAction": "はい、クルーを更新",
  ...
  "settings.updateCard.packPatience": "操作は不要です。自動で完了します。",
