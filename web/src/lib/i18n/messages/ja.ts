...
export const ja: Dictionary = {
  ...
  // --- live (OMP Codex WebRTC 通話) ---
  "live.control.open": "ライブ通話",
  "live.control.openAria": "ライブコーディング通話を開く",
  "live.sheet.title": "ライブコーディング通話",
  "live.control.start": "通話を開始",
  "live.control.mute": "ミュート",
  "live.control.unmute": "ミュート解除",
  "live.control.end": "終了",
  "live.control.play": "通話音声を再生",
  "live.unavailable": "この OMP ペインではライブ通話を利用できません。",
  "live.phase.idle": "準備ができたら開始できます",
  "live.phase.connecting": "接続中…",
  "live.phase.listening": "聞いています",
  "live.phase.working": "作業中",
  "live.phase.muted": "マイクをミュート中",
  "live.phase.error": "通話に対応が必要です",
  "live.transcript.title": "直近の通話文字起こし",
  "live.transcript.user": "あなた:",
  "live.transcript.assistant": "Codex:",
  "live.limitation":
    "話している間はこの画面を開いたままにしてください。Collie は表示中に画面を起動したままにできますが、電話をロックすると通話が中断される場合があります。",
  "live.error.secureContext": "ライブ通話には安全な接続（HTTPS）が必要です。",
  "live.error.mediaUnavailable": "このブラウザはマイクにアクセスできません。",
  "live.error.webrtcUnavailable": "このブラウザは WebRTC ライブ通話に対応していません。",
  "live.error.permission": "マイクの許可が拒否されました。",
  "live.error.microphone": "使用できるマイクが見つかりません。",
  "live.error.network": "この通話のネットワーク接続に失敗しました。",
  "live.error.server": "ライブ通話サービスの応答: {error}",
  "live.error.channelClosed": "ライブ通話の接続が閉じました。",
  "live.error.readyTimeout": "ライブ通話の準備が時間内に完了しませんでした。",
  "live.error.protocol": "ライブ通話サービスが無効な応答を返しました。",
  "live.error.disconnected": "ライブ通話が切断されました。再接続するには新しい通話を開始してください。",
