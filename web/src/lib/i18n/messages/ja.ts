...
export const ja: Dictionary = {
  ...
  "settings.updateCard.peer.state.packageManaged": "パッケージ管理者を待機中",
  ...
  "updateRibbon.packageManaged.one": "{names} はパッケージ管理者待ち",
  "updateRibbon.packageManaged.other": "{names} はパッケージ管理者待ち",
