...
export const ja: Dictionary = {
  ...
  "apiError.worktree.remove_failed": "worktree を削除できませんでした：{reason}",
  "apiError.worktree.dirty": "この worktree にはコミットされていない変更があります：{reason}",
  ...
  "apiError.worktree.not_open": "その worktree はスペースとして開かれていないため、ここからは削除できません。",
  ...
  "worktree.remove": "削除",
  "worktree.removeConfirm": "worktree を削除しますか？",
  "worktree.removeForce": "変更を破棄して削除しますか？",
  "worktree.removing": "削除中…",
  "worktree.mainCheckout": "リポジトリ本体",
  "worktree.notOpenHint": "削除するには先に開いてください。",
