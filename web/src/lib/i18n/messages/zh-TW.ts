...
export const zhTW: Dictionary = {
  ...
  "composer.upload.success": "已加入圖片，路徑已填入訊息",
  ...
  "pack.title": "Pack",
  "pack.nav.back": "返回上一層",
  "pack.entry.title": "Pack 狀態總覽",
  "pack.entry.description": "Pack 中各節點的執行狀態。",
  "pack.footer.label": "Pack · {machines} · {reachable}",
  "pack.footer.aria": "開啟 Pack 總覽面板",
  "pack.summary.counts": "{machines} · {reachable}",
  "pack.summary.machines.one": "{count} 個節點",
  "pack.summary.machines.other": "{count} 個節點",
  "pack.summary.reachable": "{count} 個在線",
  "pack.summary.deputy": "Deputy 節點",
  "pack.summary.noDeputy": "未指定 Deputy 節點",
  "pack.summary.warrant": "授權世代 {generation}",
  "pack.summary.secret": "金鑰",
  "pack.summary.secretValue": "版本 {generation} · 輪替於 {time}",
  "pack.member.health": "健康狀態",
  "pack.member.reason": "異常原因",
  "pack.member.conflict": "叢集衝突",
  "pack.member.conflictValue": "{lead} 同樣宣告為 Lead · 授權世代 {generation}",
  "pack.member.conflictNoWarrant": "{lead} 同樣宣告為 Lead · 沒有有效授權",
  "pack.member.version": "軟體版本",
  "pack.member.versionDiffers": "與 Lead 節點版本不一致",
  "pack.member.address": "節點位址",
  "pack.member.enrolled": "註冊時間",
  "pack.member.secretBehind": "尚未同步最新金鑰。",
  "pack.member.provisional": "節點已註冊，但從未建立有效連線。",
  "pack.health.reachable": "正常",
  "pack.health.unreachable": "離線",
  "pack.health.incompatible": "版本衝突",
  "pack.health.conflicted": "狀態衝突",
  "pack.role.deputy": "deputy",
  "pack.sheet.goTo": "切換到此主機",
  "pack.formation.aria": "叢集拓撲：{machines}",
  "pack.node.aria": "{name}，{role}，{health}",
  "pack.node.ariaPlain": "{name}，{health}",
  "pack.solo.title": "目前 collie 執行個體未加入任何 pack",
  "pack.solo.description": "Pack 必須在命令列中建立和管理。",
  "pack.error.title": "無法取得 pack 狀態",
  "pack.error.description": "Bridge 未回應，Collie 將在下次輪詢時重試。",
  ...
  "apiError.upload.too_large": "圖片檔案過大，上限為 10 MB。",
  "apiError.upload.no_file": "未提供任何檔案。",
  "apiError.upload.bad_type": "Collie 不支援此檔案格式：{type}",
  "apiError.upload.write_failed": "無法在主機上儲存圖片：{reason}",
  ...
  "apiError.host.unknown": "目前 pack 中不存在名為 {host} 的 collie 執行個體。",
  "apiError.pack.not_lead": "目前 collie 不是 pack lead，沒有可顯示的 pack。",
  // --- worktrees (ADR 0032) ---
  ...
  "settings.updateCard.actionPack": "將 Pack 更新到 {version}",
  "settings.updateCard.retryPack": "重試 Pack 更新",
  "settings.updateCard.packConfirmTitle": "將 Pack 更新到 {version}？",
  "settings.updateCard.packConfirmBody": "本機先更新。接著各 Peer 節點會同步升級至相同版本、自我檢查健康狀態，並在失敗時自行復原。",
  "settings.updateCard.packConfirmAction": "是，更新 Pack",
  "settings.updateCard.retryConfirmTitle": "重試 Pack 更新？",
  "settings.updateCard.retryConfirmBody": "本機已是最新版本，只對其他 Peer 節點重試。每個節點再嘗試一次。",
  "settings.updateCard.retryConfirmAction": "是，重試",
  "settings.updateCard.peers.label": "Pack 成員",
  ...
  "updates.entry.description": "更新 Collie，並同步更新 Pack。",
