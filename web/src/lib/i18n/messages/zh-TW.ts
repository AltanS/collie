...
export const zhTW: Dictionary = {
  ...
  "paneActions.fit.label": "配合手機尺寸",
  "paneActions.fit.release": "解除手機尺寸配合",
  "paneActions.fit.failed": "無法配合手機尺寸",
  "paneActions.fit.unmeasurable": "無法測量此手機上的終端機檢視。",
  "paneActions.fit.fitting": "正在配合手機尺寸…",
  "paneActions.fit.fitted": "已配合為 {cols}×{rows}",
  ...
  "apiError.pane.fit_busy": "另一台裝置或工具正在控制此終端機的尺寸。請在其釋放後再試一次。",
  "apiError.pane.fit_lapsed": "手機尺寸配合已過期。點擊「配合手機尺寸」重新配合。",
  "apiError.pane.fit_failed": "無法將窗格配合手機尺寸：{reason}",
  "apiError.pane.fit_invalid": "尺寸超出範圍：終端機支援 {minCols}–{maxCols} 欄、{minRows}–{maxRows} 列。",
