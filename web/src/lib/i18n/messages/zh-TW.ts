...
export const zhTW: Dictionary = {
  ...
  "pack.title": "機組",
  "pack.nav.back": "返回上一層",
  "pack.entry.title": "機組狀態總覽",
  "pack.entry.description": "機組中各節點的執行狀態。",
  "pack.footer.label": "機組 · {machines} · {reachable}",
  "pack.footer.aria": "開啟機組總覽面板",
  ...
  "pack.formation.aria": "機組拓撲：{machines}",
  "pack.node.aria": "{name}，{role}，{health}",
  "pack.node.ariaPlain": "{name}，{health}",
  "pack.solo.title": "目前 collie 執行個體未領導任何機組",
  "pack.solo.description": "機組必須在命令列中建立和管理。",
  "pack.error.title": "無法取得機組狀態",
  ...
  "settings.updateCard.actionPack": "將機組更新到 {version}",
  "settings.updateCard.retryPack": "重試機組更新",
  "settings.updateCard.retryNow": "重試",
  "settings.updateCard.packConfirmTitle": "將機組更新到 {version}？",
  "settings.updateCard.packConfirmBody": "本機先更新。接著各成員節點會同步升級至相同版本、自我檢查健康狀態，並在失敗時自行復原。",
  "settings.updateCard.packConfirmAction": "是，更新機組",
