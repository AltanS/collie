...
export const en = {
  ...
  // --- tour (the first-launch sheet, web/src/components/tour-sheet.tsx) ---
  // Three slides, shown once per device and then only when the operator asks in Settings. The
  // English here is the source of truth; the six other catalogs carry it verbatim until it is
