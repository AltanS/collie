...
export const en = {
  ...
  "apiError.worktree.remove_failed": "The worktree couldn't be removed: {reason}",
  "apiError.worktree.dirty": "That worktree has uncommitted work: {reason}",
  ...
  "apiError.worktree.not_open": "That worktree isn't open as a space, so it can't be removed from here.",
