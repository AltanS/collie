...
export const en = {
  ...
  // --- live (OMP Codex WebRTC call) ---
  "live.control.open": "Live call",
  "live.control.openAria": "Open live coding call",
  "live.sheet.title": "Live coding call",
  "live.control.start": "Start call",
  "live.control.mute": "Mute",
  "live.control.unmute": "Unmute",
  "live.control.end": "End",
  "live.control.play": "Play call audio",
  "live.unavailable": "Live calls are not available for this OMP pane.",
  ...
  "live.phase.muted": "Microphone muted",
  "live.phase.error": "Call needs attention",
  "live.transcript.title": "Latest call transcript",
  "live.transcript.user": "You:",
  "live.transcript.assistant": "Codex:",
  "live.limitation":
    "Keep this screen open while you talk. Collie can hold the screen awake while visible, but a locked phone may interrupt the call.",
  "live.error.secureContext": "Live calls need a secure connection (HTTPS).",
  "live.error.mediaUnavailable": "This browser cannot access the microphone.",
  "live.error.webrtcUnavailable": "This browser does not support WebRTC live calls.",
  "live.error.permission": "Microphone permission was denied.",
  "live.error.microphone": "No usable microphone was found.",
  "live.error.network": "The network connection for this call failed.",
  "live.error.server": "The live-call service said: {error}",
  "live.error.channelClosed": "The live call connection closed.",
  "live.error.readyTimeout": "The live call did not become ready in time.",
  "live.error.protocol": "The live-call service returned an invalid response.",
  "live.error.disconnected": "The live call disconnected. Start a new call to reconnect.",
