...
export const de: Dictionary = {
  ...
  // --- live (OMP Codex-WebRTC-Anruf) ---
  "live.control.open": "Live-Anruf",
  "live.control.openAria": "Live-Coding-Anruf öffnen",
  "live.sheet.title": "Live-Coding-Anruf",
  "live.control.start": "Anruf starten",
  "live.control.mute": "Stummschalten",
  "live.control.unmute": "Stummschaltung aufheben",
  "live.control.end": "Beenden",
  "live.control.play": "Anrufaudio abspielen",
  "live.unavailable": "Live-Anrufe sind für diesen OMP-Bereich nicht verfügbar.",
  "live.phase.idle": "Bereit, wenn du es bist",
  "live.phase.connecting": "Verbinden…",
  "live.phase.listening": "Hört zu",
  "live.phase.working": "Arbeitet",
  "live.phase.muted": "Mikrofon stummgeschaltet",
  "live.phase.error": "Anruf braucht Aufmerksamkeit",
  "live.transcript.title": "Letztes Anrufprotokoll",
  "live.transcript.user": "Du:",
  "live.transcript.assistant": "Codex:",
  "live.limitation":
    "Lass diesen Bildschirm beim Sprechen geöffnet. Collie kann ihn sichtbar wach halten, aber ein gesperrtes Telefon kann den Anruf unterbrechen.",
  "live.error.secureContext": "Live-Anrufe benötigen eine sichere Verbindung (HTTPS).",
  "live.error.mediaUnavailable": "Dieser Browser kann nicht auf das Mikrofon zugreifen.",
  "live.error.webrtcUnavailable": "Dieser Browser unterstützt keine WebRTC-Live-Anrufe.",
  "live.error.permission": "Die Mikrofonberechtigung wurde verweigert.",
  "live.error.microphone": "Es wurde kein nutzbares Mikrofon gefunden.",
  "live.error.network": "Die Netzwerkverbindung für diesen Anruf ist fehlgeschlagen.",
  "live.error.server": "Der Live-Anrufdienst meldet: {error}",
  "live.error.channelClosed": "Die Live-Anrufverbindung wurde geschlossen.",
  "live.error.readyTimeout": "Der Live-Anruf wurde nicht rechtzeitig bereit.",
  "live.error.protocol": "Der Live-Anrufdienst hat eine ungültige Antwort geliefert.",
  "live.error.disconnected": "Der Live-Anruf wurde getrennt. Starte einen neuen Anruf zum Wiederverbinden.",
