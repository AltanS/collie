...
export const de: Dictionary = {
  ...
  "paneActions.focus.labelFallback": "Im Terminal anzeigen",
  "paneActions.focus.done": "Im Terminal angezeigt",
  "paneActions.focus.failed": "Konnte es nicht im Terminal anzeigen",
  ...
  "apiError.worktree.remove_failed": "Der Worktree konnte nicht entfernt werden: {reason}",
  "apiError.worktree.dirty": "Dieser Worktree hat nicht committete Änderungen: {reason}",
  ...
  "apiError.worktree.not_open": "Dieser Worktree ist nicht als Space geöffnet und kann von hier nicht entfernt werden.",
  ...
  "worktree.removeConfirm": "Worktree entfernen?",
  "worktree.removeForce": "Änderungen verwerfen und entfernen?",
  "worktree.removing": "Wird entfernt…",
  "worktree.mainCheckout": "das Repository selbst",
  "worktree.notOpenHint": "Zum Entfernen zuerst öffnen.",
