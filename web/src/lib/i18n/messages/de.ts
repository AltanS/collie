...
export const de: Dictionary = {
  ...
  "pack.entry.title": "Crew-Übersicht",
  "pack.entry.description": "Status aller Rechner in der Crew.",
  "pack.footer.label": "Crew · {machines} · {reachable}",
  "pack.footer.aria": "Crew-Übersicht öffnen",
  ...
  "pack.formation.aria": "Crew-Aufstellung: {machines}",
  "pack.node.aria": "{name}, {role}, {health}",
  "pack.node.ariaPlain": "{name}, {health}",
  "pack.solo.title": "Dieser Collie führt keine Crew",
  "pack.solo.description": "Crews werden über die Kommandozeile erstellt und verwaltet.",
  "pack.error.title": "Crew-Status konnte nicht geladen werden",
  ...
  // --- M16/01: the updates page, its pack lines and the Settings row ---
  "settings.updateCard.actionPack": "Crew auf {version} aktualisieren",
  "settings.updateCard.retryPack": "Crew-Update wiederholen",
  "settings.updateCard.retryNow": "Jetzt wiederholen",
  "settings.updateCard.packConfirmTitle": "Crew auf {version} aktualisieren?",
  "settings.updateCard.packConfirmBody": "Diese Maschine beginnt. Danach aktualisiert sich jedes Crew-Mitglied selbst auf dieselbe Version, prüft den eigenen Zustand und setzt sich bei Fehlern selbstständig zurück.",
  "settings.updateCard.packConfirmAction": "Ja, Crew aktualisieren",
  ...
  "settings.updateCard.packPatience": "Nichts tun, das läuft von allein durch.",
