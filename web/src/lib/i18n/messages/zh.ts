...
export const zh: Dictionary = {
  ...
  // --- live (OMP Codex WebRTC 通话) ---
  "live.control.open": "实时通话",
  "live.control.openAria": "打开实时编程通话",
  "live.sheet.title": "实时编程通话",
  "live.control.start": "开始通话",
  "live.control.mute": "静音",
  "live.control.unmute": "取消静音",
  "live.control.end": "结束",
  "live.control.play": "播放通话音频",
  "live.unavailable": "此 OMP 窗格无法使用实时通话。",
  "live.phase.idle": "准备好后即可开始",
  "live.phase.connecting": "正在连接…",
  "live.phase.listening": "正在聆听",
  "live.phase.working": "正在工作",
  "live.phase.muted": "麦克风已静音",
  "live.phase.error": "通话需要处理",
  "live.transcript.title": "最近通话转录",
  "live.transcript.user": "你：",
  "live.transcript.assistant": "Codex：",
  "live.limitation":
    "通话时请保持此屏幕打开。Collie 可在屏幕可见时保持其唤醒，但锁定手机可能会中断通话。",
  "live.error.secureContext": "实时通话需要安全连接（HTTPS）。",
  "live.error.mediaUnavailable": "此浏览器无法访问麦克风。",
  "live.error.webrtcUnavailable": "此浏览器不支持 WebRTC 实时通话。",
  "live.error.permission": "麦克风权限被拒绝。",
  "live.error.microphone": "未找到可用的麦克风。",
  "live.error.network": "此通话的网络连接失败。",
  "live.error.server": "实时通话服务返回：{error}",
  "live.error.channelClosed": "实时通话连接已关闭。",
  "live.error.readyTimeout": "实时通话未能及时准备就绪。",
  "live.error.protocol": "实时通话服务返回了无效响应。",
  "live.error.disconnected": "实时通话已断开。请开始新通话以重新连接。",
