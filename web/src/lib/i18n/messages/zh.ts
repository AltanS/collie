...
export const zh: Dictionary = {
  ...
  "paneActions.fit.label": "适配手机",
  "paneActions.fit.release": "解除手机适配",
  "paneActions.fit.failed": "无法适配手机",
  "paneActions.fit.unmeasurable": "无法测量此手机上的终端视图。",
  "paneActions.fit.fitting": "正在适配手机…",
  "paneActions.fit.fitted": "已适配为 {cols}×{rows}",
  ...
  "apiError.pane.fit_busy": "另一台设备或工具正在控制此终端的尺寸。请在其释放后重试。",
  "apiError.pane.fit_lapsed": "手机适配已过期。点击“适配手机”重新适配。",
  "apiError.pane.fit_failed": "无法将窗格适配手机：{reason}",
  "apiError.pane.fit_invalid": "尺寸超出范围：终端支持 {minCols}–{maxCols} 列、{minRows}–{maxRows} 行。",
