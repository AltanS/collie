...
export const zh: Dictionary = {
  ...
  "pack.title": "机组",
  "pack.nav.back": "返回上一级",
  "pack.entry.title": "机组状态总览",
  "pack.entry.description": "机组内各节点的运行状态。",
  "pack.footer.label": "机组 · {machines} · {reachable}",
  "pack.footer.aria": "打开机组总览面板",
  ...
  "pack.formation.aria": "机组拓扑：{machines}",
  "pack.node.aria": "{name}，{role}，{health}",
  "pack.node.ariaPlain": "{name}，{health}",
  "pack.solo.title": "当前 collie 实例未管理任何机组",
  "pack.solo.description": "机组需在命令行中创建和管理。",
  "pack.error.title": "无法获取机组状态",
  ...
  "apiError.pack.not_lead": "当前 collie 不是机组 lead，无可展示的机组。",
  // --- worktrees (ADR 0032) ---
  ...
  // --- M16/01: the updates page, its pack lines and the Settings row ---
  "settings.updateCard.actionPack": "将机组更新到 {version}",
  "settings.updateCard.retryPack": "重试机组更新",
  "settings.updateCard.retryNow": "重试",
  "settings.updateCard.packConfirmTitle": "将机组更新到 {version}？",
  "settings.updateCard.packConfirmBody": "本机先更新。随后各成员节点会同步升至同一版本，自检健康状态，并在失败时自行回滚。",
  "settings.updateCard.packConfirmAction": "是，更新机组",
  ...
  "settings.updateCard.packPatience": "无需操作，将自动完成。",
