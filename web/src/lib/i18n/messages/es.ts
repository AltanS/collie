...
export const es: Dictionary = {
  ...
  // --- live (llamada WebRTC de OMP Codex) ---
  "live.control.open": "Llamada en vivo",
  "live.control.openAria": "Abrir llamada de programación en vivo",
  "live.sheet.title": "Llamada de programación en vivo",
  "live.control.start": "Iniciar llamada",
  "live.control.mute": "Silenciar",
  "live.control.unmute": "Activar micrófono",
  "live.control.end": "Finalizar",
  "live.control.play": "Reproducir audio de la llamada",
  "live.unavailable": "Las llamadas en vivo no están disponibles para este panel OMP.",
  "live.phase.idle": "Listo cuando tú lo estés",
  "live.phase.connecting": "Conectando…",
  "live.phase.listening": "Escuchando",
  "live.phase.working": "Trabajando",
  "live.phase.muted": "Micrófono silenciado",
  "live.phase.error": "La llamada necesita atención",
  "live.transcript.title": "Transcripción reciente de la llamada",
  "live.transcript.user": "Tú:",
  "live.transcript.assistant": "Codex:",
  "live.limitation":
    "Mantén esta pantalla abierta mientras hablas. Collie puede mantenerla encendida cuando está visible, pero un teléfono bloqueado puede interrumpir la llamada.",
  "live.error.secureContext": "Las llamadas en vivo necesitan una conexión segura (HTTPS).",
  "live.error.mediaUnavailable": "Este navegador no puede acceder al micrófono.",
  "live.error.webrtcUnavailable": "Este navegador no admite llamadas WebRTC en vivo.",
  "live.error.permission": "Se denegó el permiso del micrófono.",
  "live.error.microphone": "No se encontró un micrófono utilizable.",
  "live.error.network": "Falló la conexión de red de esta llamada.",
  "live.error.server": "El servicio de llamada en vivo indicó: {error}",
  "live.error.channelClosed": "La conexión de llamada en vivo se cerró.",
  "live.error.readyTimeout": "La llamada en vivo no estuvo lista a tiempo.",
  "live.error.protocol": "El servicio de llamada en vivo devolvió una respuesta no válida.",
  "live.error.disconnected": "La llamada en vivo se desconectó. Inicia una nueva llamada para reconectar.",
