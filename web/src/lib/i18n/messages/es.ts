...
export const es: Dictionary = {
  ...
  "pack.entry.title": "Resumen del equipo",
  "pack.entry.description": "Estado de cada máquina del equipo.",
  "pack.footer.label": "Equipo · {machines} · {reachable}",
  "pack.footer.aria": "Abrir el resumen del equipo",
  ...
  "pack.formation.aria": "Formación del equipo: {machines}",
  "pack.node.aria": "{name}, {role}, {health}",
  "pack.node.ariaPlain": "{name}, {health}",
  "pack.solo.title": "Este collie no lidera ningún equipo",
  "pack.solo.description": "Un equipo se crea y modifica desde la línea de comandos.",
  "pack.error.title": "Error al cargar el estado del equipo",
  ...
  // --- M16/01: the updates page, its pack lines and the Settings row ---
  "settings.updateCard.actionPack": "Actualizar el equipo a {version}",
  "settings.updateCard.retryPack": "Reintentar actualización del equipo",
  "settings.updateCard.retryNow": "Reintentar",
  "settings.updateCard.packConfirmTitle": "¿Actualizar el equipo a {version}?",
  "settings.updateCard.packConfirmBody": "Esta máquina va primero. Luego cada miembro pasa a la misma versión, comprueba su propio estado y revierte por su cuenta si falla.",
  "settings.updateCard.packConfirmAction": "Sí, actualizar el equipo",
  ...
  "settings.updateCard.packPatience": "No hagas nada, terminará solo.",
