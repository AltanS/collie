...
export const es: Dictionary = {
  ...
  "connection.session.allDescription": "Todas las sesiones de esta máquina, en una lista",
  ...
  "apiError.worktree.remove_failed": "No se pudo eliminar el worktree: {reason}",
  "apiError.worktree.dirty": "Ese worktree tiene cambios sin confirmar: {reason}",
  ...
  "apiError.worktree.not_open": "Ese worktree no está abierto como espacio, así que no se puede eliminar desde aquí.",
  ...
  "worktree.remove": "Eliminar",
  "worktree.removeConfirm": "¿Eliminar el worktree?",
  "worktree.removeForce": "¿Descartar los cambios y eliminar?",
  "worktree.removing": "Eliminando…",
  "worktree.mainCheckout": "el repositorio en sí",
  "worktree.notOpenHint": "Ábrelo para poder eliminarlo.",
