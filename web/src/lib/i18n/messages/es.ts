...
export const es: Dictionary = {
  ...
  "apiError.launch.pane_unknown": "Ese panel ya no existe, no se lanzó nada",
  ...
  "settings.updateCard.upToDate": "Esta es la versión más reciente.",
  ...
  "settings.updateCard.preflight": "Comprobación previa",
