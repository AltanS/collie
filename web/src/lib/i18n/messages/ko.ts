...
export const ko: Dictionary = {
  ...
  "paneActions.fit.label": "휴대폰에 맞추기",
  "paneActions.fit.release": "휴대폰 맞춤 해제",
  "paneActions.fit.failed": "휴대폰에 맞추지 못했습니다",
  "paneActions.fit.unmeasurable": "이 휴대폰에서 터미널 보기 크기를 측정하지 못했습니다.",
  "paneActions.fit.fitting": "휴대폰에 맞추는 중…",
  "paneActions.fit.fitted": "{cols}×{rows}에 맞춤",
  "paneActions.fit.releaseShort": "해제",
  ...
  "apiError.pane.fit_busy":
    "다른 기기나 도구가 이 터미널의 크기를 제어하고 있습니다. 제어가 해제된 뒤 다시 시도하세요.",
  "apiError.pane.fit_lapsed": "휴대폰 맞춤이 이미 만료되었습니다. '휴대폰에 맞추기'를 눌러 다시 맞추세요.",
  "apiError.pane.fit_failed": "창을 휴대폰에 맞추지 못했습니다: {reason}",
  "apiError.pane.fit_invalid":
    "크기가 범위를 벗어났습니다. 터미널은 {minCols}–{maxCols}열, {minRows}–{maxRows}행을 지원합니다.",
