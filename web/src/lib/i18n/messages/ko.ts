...
export const ko: Dictionary = {
  ...
  "pack.title": "크루",
  "pack.nav.back": "뒤로",
  "pack.entry.title": "크루 개요",
  "pack.entry.description": "크루 내 각 머신의 상태입니다.",
  "pack.footer.label": "크루 · {machines} · {reachable}",
  "pack.footer.aria": "크루 개요 열기",
  ...
  "pack.formation.aria": "크루 구성: {machines}",
  "pack.node.aria": "{name}, {role}, {health}",
  "pack.node.ariaPlain": "{name}, {health}",
  "pack.solo.title": "이 collie는 크루를 lead하고 있지 않습니다",
  "pack.solo.description": "CLI에서 크루를 생성하고 변경합니다.",
  "pack.error.title": "크루 상태 조회 실패",
  ...
  // --- M16/01: the updates page, its pack lines and the Settings row ---
  "settings.updateCard.actionPack": "크루를 {version}(으)로 업데이트",
  "settings.updateCard.retryPack": "크루 업데이트 다시 시도",
  "settings.updateCard.retryNow": "다시 시도",
  "settings.updateCard.packConfirmTitle": "크루를 {version}(으)로 업데이트할까요?",
  "settings.updateCard.packConfirmBody": "이 머신이 먼저 업데이트됩니다. 그런 다음 각 멤버가 동일한 릴리스로 맞추고, 자체 상태를 점검한 뒤 실패 시 스스로 롤백합니다.",
  "settings.updateCard.packConfirmAction": "예, 크루 업데이트",
  ...
  "settings.updateCard.packPatience": "그냥 두세요. 알아서 끝납니다.",
