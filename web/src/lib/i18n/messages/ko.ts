...
export const ko: Dictionary = {
  ...
  // --- live (OMP Codex WebRTC 통화) ---
  "live.control.open": "라이브 통화",
  "live.control.openAria": "라이브 코딩 통화 열기",
  "live.sheet.title": "라이브 코딩 통화",
  "live.control.start": "통화 시작",
  "live.control.mute": "음소거",
  "live.control.unmute": "음소거 해제",
  "live.control.end": "종료",
  "live.control.play": "통화 오디오 재생",
  "live.unavailable": "이 OMP 창에서는 라이브 통화를 사용할 수 없습니다.",
  "live.phase.idle": "준비되면 시작할 수 있습니다",
  "live.phase.connecting": "연결 중…",
  "live.phase.listening": "듣는 중",
  "live.phase.working": "작업 중",
  "live.phase.muted": "마이크 음소거됨",
  "live.phase.error": "통화에 확인이 필요합니다",
  "live.transcript.title": "최근 통화 기록",
  "live.transcript.user": "나:",
  "live.transcript.assistant": "Codex:",
  "live.limitation":
    "말하는 동안 이 화면을 열어 두세요. Collie는 화면이 보일 때 켜진 상태를 유지할 수 있지만, 휴대폰을 잠그면 통화가 중단될 수 있습니다.",
  "live.error.secureContext": "라이브 통화에는 보안 연결(HTTPS)이 필요합니다.",
  "live.error.mediaUnavailable": "이 브라우저는 마이크에 접근할 수 없습니다.",
  "live.error.webrtcUnavailable": "이 브라우저는 WebRTC 라이브 통화를 지원하지 않습니다.",
  "live.error.permission": "마이크 권한이 거부되었습니다.",
  "live.error.microphone": "사용 가능한 마이크를 찾을 수 없습니다.",
  "live.error.network": "이 통화의 네트워크 연결에 실패했습니다.",
  "live.error.server": "라이브 통화 서비스 응답: {error}",
  "live.error.channelClosed": "라이브 통화 연결이 닫혔습니다.",
  "live.error.readyTimeout": "라이브 통화가 제시간에 준비되지 않았습니다.",
  "live.error.protocol": "라이브 통화 서비스가 잘못된 응답을 반환했습니다.",
  "live.error.disconnected": "라이브 통화가 끊어졌습니다. 다시 연결하려면 새 통화를 시작하세요.",
  ...
  // --- M16/01: the updates page, its pack lines and the Settings row ---
  "settings.updateCard.actionPack": "Pack을 {version}(으)로 업데이트",
  "settings.updateCard.retryPack": "Pack 업데이트 다시 시도",
  "settings.updateCard.packConfirmTitle": "Pack을 {version}(으)로 업데이트할까요?",
  "settings.updateCard.packConfirmBody": "이 머신이 먼저 업데이트됩니다. 그런 다음 각 피어가 동일한 릴리스로 맞추고, 자체 상태를 점검한 뒤 실패 시 스스로 롤백합니다.",
  "settings.updateCard.packConfirmAction": "예, Pack 업데이트",
  "settings.updateCard.retryConfirmTitle": "Pack 업데이트를 다시 시도할까요?",
  ...
  "settings.updateCard.peers.label": "Pack 구성원",
  ...
  "updates.entry.description": "Collie 및 Pack을 함께 업데이트합니다.",
