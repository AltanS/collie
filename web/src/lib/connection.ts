...
// (which not-live cause to name) in ConnectionBar and OutageBanner — never as a liveness gate. The
...
// load trips it. Mirrors the not-"live" branches of ConnectionBar's status resolver.
