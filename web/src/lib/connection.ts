...
// (which not-live cause to name) in ConnectionPill and OutageBanner — never as a liveness gate. The
...
// load trips it. Mirrors the not-"live" branches of ConnectionPill's status resolver.
